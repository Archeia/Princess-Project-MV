	...
	var TiledTilemap = exports.TiledTilemap = function (_ShaderTilemap) {
	    ...
	    _createClass(TiledTilemap, [{
	        ...
	        value: function _setupAnim() {
	            ...
	            try {
	                for (var _iterator = this.tiledData.tilesets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    ...
	                    try {
	                        for (var _iterator2 = tilesData[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	        ...
	        value: function _updateAnimFrames() {
	            ...
	            try {
	                for (var _iterator6 = this.tiledData.tilesets[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	                    ...
	                    try {
	                        for (var _iterator7 = tilesData[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
	        ...
	        value: function _getAnimTileId(textureId, tileId) {
	            ...
	            var tile = this._getTileData(tilesData, tileId);
	            if (!tile) {
	                return tileId;
	            }
	            if (!tile.animation) {
	        ...
	        key: '_getTileData',
	        value: function _getTileData(tilesData, tileId) {
	            var _iteratorNormalCompletion16 = true;
	            var _didIteratorError16 = false;
	            var _iteratorError16 = undefined;

	            try {
	                for (var _iterator16 = tilesData[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
	        ...
	        value: function hideOnLevel(level) {
	            ...
	            try {
	                for (var _iterator17 = this._layers[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
	            ...
	            try {
	                for (var _iterator18 = this._priorityTiles[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
